...
class Experiment:
	...
	def plot_data(self, ax = plt, legend = True):
		...
		ax.plot(self.data[:,0], self.data[:,1], label = "Septum pierced approx. 40 times", color = 'blue', linewidth = 1.5)
		ax.set_xlim(0, 1350)
...
def main():
	...
	exp = Experiment('2024-04-03_091640_AE-250-2-Ch1.txt', channel = 1, sensors = 1)
	#'190125_JS_526_2.txt'
